...
export function MaintenanceOverviewChart() {
    const { data, isLoading, isError } = useQuery(maintenanceRequestOverviewStatCardKpiViewQuery());

    if (isLoading) {
        return (
            <Card>
                <CardHeader className="pb-3">
                    <CardTitle className="text-base font-semibold">Maintenance Overview</CardTitle>
                </CardHeader>
                <CardContent>
