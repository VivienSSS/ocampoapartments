...
import { ScatterChart, Scatter, CartesianGrid, XAxis, YAxis, ResponsiveContainer, Cell } from 'recharts';
        ...
        return (
            <Card>
                <CardHeader className="pb-3">
                    <CardTitle className="text-base font-semibold">Unit Inventory</CardTitle>
                </CardHeader>
                <CardContent>
