...
export const columns: ColumnDef<MaintenanceRequestsResponse>[] = [
    ...
    {
        accessorKey: 'urgency',
        header: ({ column }) => <TableColumnHeader column={column} title="Urgency" />,
    },
    {
        accessorKey: 'status',
    ...
    {
        accessorKey: 'worker',
        header: ({ column }) => <TableColumnHeader column={column} title="Worker" />,
    },
    {
    ...
    },
    {
        ...
        header: ({ column }) => <TableColumnHeader column={column} title="Submitted Date" />,
    },
    {
        accessorKey: 'completedDate',
        header: ({ column }) => <TableColumnHeader column={column} title="Completed Date" />,
    },
];
