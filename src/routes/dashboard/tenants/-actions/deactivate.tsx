    ...
    return (
        ...
        >
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>
                        Are you sure to deactivate {tenants?.map((record) => `\`${record.expand.user.firstName} ${record.expand.user.lastName}\``).join(',')}
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                        The tenant will be marked as inactive and will not be able to access the system.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
