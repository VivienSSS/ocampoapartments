...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: 'apartment_units',
  ): RecordService<ApartmentUnitsResponse>;
  collection(idOrName: 'bill_items'): RecordService<BillItemsResponse>;
  collection(idOrName: 'bills'): RecordService<BillsResponse>;
  collection(
    idOrName: 'maintenance_requests',
  ): RecordService<MaintenanceRequestsResponse>;
  collection(
    idOrName: 'maintenance_workers',
  ): RecordService<MaintenanceWorkersResponse>;
