...
export type BillItemAnalysisStatCardKpiViewRecord<
  TavgAmount = unknown,
  TpercentageOfTotal = unknown,
  TtotalAmount = unknown,
> = {
...
export type BillsByStatusChartViewRecord<
  TavgAmount = unknown,
  TtotalAmount = unknown,
> = {
  avgAmount?: null | TavgAmount;
...
export type FinancialStatCardKpiViewRecord<
  Tpayment_collection_rate = unknown,
  Ttotal_bill_amount = unknown,
  Ttotal_outstanding = unknown,
  Ttotal_paid = unknown,
  Ttotal_received = unknown,
> = {
  id: string;
...
export type HighPriorityUnresolvedRequestsStatCardKpiViewRecord<
  TdaysOpen = unknown,
  TpriorityLabel = unknown,
> = {
...
export type MaintenanceRequestOverviewStatCardKpiViewRecord<
  TassignmentRate = unknown,
  TavgCompletionDays = unknown,
> = {
...
export type MaintenanceRequestStatusStatCardKpiViewRecord<
  TavgResolutionDays = unknown,
> = {
...
export type MonthlyRevenueTrendStatCardKpiViewRecord<
  TavgPaymentSize = unknown,
  Tmonth = unknown,
  TmonthlyRevenue = unknown,
> = {
...
export type OutstandingReceivablesChartViewRecord<
  TmostRecentDueDate = unknown,
  TtotalOutstanding = unknown,
  TurgencyLevel = unknown,
> = {
  email: string;
  firstName: string;
  id: string;
...
export type PaymentMethodsDistributionChartViewRecord<
  TavgPaymentAmount = unknown,
  TpaymentMethodPercentage = unknown,
...
export type PorfolioStatCardKpiViewRecord<
  Toverall_occupancy_rate = unknown,
  Ttotal_monthly_potential_revenue = unknown,
> = {
  id: string;
...
export type PropertyHealthDashboardChartViewRecord<
  ToccupancyRate = unknown,
  ToutstandingAmount = unknown,
  TtotalMonthlyPotential = unknown,
> = {
  address: HTMLString;
...
export type PropertySummaryChartViewRecord<
  TavailableUnits = unknown,
  ToccupancyRate = unknown,
  ToccupiedUnits = unknown,
> = {
  address: HTMLString;
...
export type RecentAnnouncementsChartViewRecord<
  TauthorName = unknown,
  TmessagePreview = unknown,
  Trecency = unknown,
> = {
...
export type RevenuePerPropertyChartViewRecord<
  TcurrentMonthlyRevenue = unknown,
  TrevenueUtilizationRate = unknown,
  TtotalPotentialMonthlyRevenue = unknown,
> = {
  address: HTMLString;
...
export type TenantFinancialOverviewChartViewRecord<
  ToutstandingBalance = unknown,
  TpaymentRatePercentage = unknown,
  TtotalBilled = unknown,
  TtotalPaid = unknown,
> = {
  email: string;
  firstName: string;
...
export type UnitPriceChartViewRecord<
  TavgPrice = unknown,
  TmaxPrice = unknown,
  TminPrice = unknown,
  TtotalMonthlyPotential = unknown,
...
export type WorkerPerformanceChartViewRecord<
  TavgResolutionDays = unknown,
  TcompletionRate = unknown,
> = {
  avgResolutionDays?: null | TavgResolutionDays;
...
export type ActiveTenanciesChartViewResponse<
  TleaseStatus = unknown,
  Texpand = unknown,
> = Required<ActiveTenanciesChartViewRecord<TleaseStatus>> &
  BaseSystemFields<Texpand>;
export type AnnouncementsResponse<Texpand = unknown> =
  Required<AnnouncementsRecord> & BaseSystemFields<Texpand>;
export type ApartmentUnitsResponse<Texpand = unknown> =
  Required<ApartmentUnitsRecord> & BaseSystemFields<Texpand>;
export type BillItemAnalysisStatCardKpiViewResponse<
  TavgAmount = unknown,
  TpercentageOfTotal = unknown,
  TtotalAmount = unknown,
  Texpand = unknown,
> = Required<
  BillItemAnalysisStatCardKpiViewRecord<
    TavgAmount,
    TpercentageOfTotal,
    TtotalAmount
  >
> &
  BaseSystemFields<Texpand>;
export type BillItemsResponse<Texpand = unknown> = Required<BillItemsRecord> &
  BaseSystemFields<Texpand>;
export type BillsResponse<Texpand = unknown> = Required<BillsRecord> &
  BaseSystemFields<Texpand>;
export type BillsByStatusChartViewResponse<
  TavgAmount = unknown,
  TtotalAmount = unknown,
  Texpand = unknown,
> = Required<BillsByStatusChartViewRecord<TavgAmount, TtotalAmount>> &
  BaseSystemFields<Texpand>;
export type FinancialStatCardKpiViewResponse<
  Tpayment_collection_rate = unknown,
  Ttotal_bill_amount = unknown,
  Ttotal_outstanding = unknown,
  Ttotal_paid = unknown,
  ...
  Texpand = unknown,
> = Required<
  FinancialStatCardKpiViewRecord<
    Tpayment_collection_rate,
    Ttotal_bill_amount,
    Ttotal_outstanding,
    Ttotal_paid,
    Ttotal_received
...
> &
  BaseSystemFields<Texpand>;
export type HighPriorityUnresolvedRequestsStatCardKpiViewResponse<
  TdaysOpen = unknown,
  TpriorityLabel = unknown,
  Texpand = unknown,
> = Required<
  HighPriorityUnresolvedRequestsStatCardKpiViewRecord<TdaysOpen, TpriorityLabel>
> &
  BaseSystemFields<Texpand>;
export type MaintenanceOperationStatCardKpiViewResponse<Texpand = unknown> =
  Required<MaintenanceOperationStatCardKpiViewRecord> &
    BaseSystemFields<Texpand>;
export type MaintenanceRequestOverviewStatCardKpiViewResponse<
  TassignmentRate = unknown,
  TavgCompletionDays = unknown,
  Texpand = unknown,
> = Required<
  MaintenanceRequestOverviewStatCardKpiViewRecord<
    TassignmentRate,
    TavgCompletionDays
  >
> &
  BaseSystemFields<Texpand>;
export type MaintenanceRequestStatusStatCardKpiViewResponse<
  TavgResolutionDays = unknown,
  Texpand = unknown,
> = Required<
  MaintenanceRequestStatusStatCardKpiViewRecord<TavgResolutionDays>
> &
  BaseSystemFields<Texpand>;
export type MaintenanceRequestsResponse<Texpand = unknown> =
  Required<MaintenanceRequestsRecord> & BaseSystemFields<Texpand>;
export type MaintenanceWorkersResponse<Texpand = unknown> =
  Required<MaintenanceWorkersRecord> & BaseSystemFields<Texpand>;
export type MonthlyRevenueTrendStatCardKpiViewResponse<
  TavgPaymentSize = unknown,
  Tmonth = unknown,
  TmonthlyRevenue = unknown,
  Texpand = unknown,
> = Required<
  MonthlyRevenueTrendStatCardKpiViewRecord<
    TavgPaymentSize,
    Tmonth,
    TmonthlyRevenue
  >
> &
  BaseSystemFields<Texpand>;
export type OutstandingReceivablesChartViewResponse<
  TmostRecentDueDate = unknown,
  TtotalOutstanding = unknown,
  TurgencyLevel = unknown,
  Texpand = unknown,
> = Required<
  OutstandingReceivablesChartViewRecord<
    TmostRecentDueDate,
    TtotalOutstanding,
    TurgencyLevel
  >
> &
  BaseSystemFields<Texpand>;
export type PaymentMethodsDistributionChartViewResponse<
  TavgPaymentAmount = unknown,
  TpaymentMethodPercentage = unknown,
  TtotalAmountPaid = unknown,
  Texpand = unknown,
> = Required<
  PaymentMethodsDistributionChartViewRecord<
    TavgPaymentAmount,
    TpaymentMethodPercentage,
    TtotalAmountPaid
  >
> &
  BaseSystemFields<Texpand>;
export type PaymentsResponse<Texpand = unknown> = Required<PaymentsRecord> &
  BaseSystemFields<Texpand>;
export type PorfolioStatCardKpiViewResponse<
  Toverall_occupancy_rate = unknown,
  Ttotal_monthly_potential_revenue = unknown,
  Texpand = unknown,
> = Required<
  PorfolioStatCardKpiViewRecord<
    Toverall_occupancy_rate,
    Ttotal_monthly_potential_revenue
  >
> &
  BaseSystemFields<Texpand>;
export type PropertiesResponse<Texpand = unknown> = Required<PropertiesRecord> &
  BaseSystemFields<Texpand>;
export type PropertyHealthDashboardChartViewResponse<
  ToccupancyRate = unknown,
  ToutstandingAmount = unknown,
  TtotalMonthlyPotential = unknown,
  Texpand = unknown,
> = Required<
  PropertyHealthDashboardChartViewRecord<
    ToccupancyRate,
    ToutstandingAmount,
    TtotalMonthlyPotential
  >
> &
  BaseSystemFields<Texpand>;
export type PropertySummaryChartViewResponse<
  TavailableUnits = unknown,
  ToccupancyRate = unknown,
  ToccupiedUnits = unknown,
  Texpand = unknown,
> = Required<
  PropertySummaryChartViewRecord<
    TavailableUnits,
    ToccupancyRate,
    ToccupiedUnits
  >
> &
  BaseSystemFields<Texpand>;
export type RecentAnnouncementsChartViewResponse<
  TauthorName = unknown,
  TmessagePreview = unknown,
  Trecency = unknown,
  Texpand = unknown,
> = Required<
  RecentAnnouncementsChartViewRecord<TauthorName, TmessagePreview, Trecency>
> &
  BaseSystemFields<Texpand>;
export type RevenuePerPropertyChartViewResponse<
  ...
  Texpand = unknown,
> = Required<
  RevenuePerPropertyChartViewRecord<
    TcurrentMonthlyRevenue,
    TrevenueUtilizationRate,
    TtotalPotentialMonthlyRevenue
  >
> &
  BaseSystemFields<Texpand>;
export type TenanciesResponse<Texpand = unknown> = Required<TenanciesRecord> &
  BaseSystemFields<Texpand>;
export type TenancyHealthChartViewResponse<
  Tavg_lease_duration_years = unknown,
  Texpand = unknown,
> = Required<TenancyHealthChartViewRecord<Tavg_lease_duration_years>> &
  BaseSystemFields<Texpand>;
export type TenantFinancialOverviewChartViewResponse<
  ToutstandingBalance = unknown,
  TpaymentRatePercentage = unknown,
  TtotalBilled = unknown,
  TtotalPaid = unknown,
  Texpand = unknown,
> = Required<
  TenantFinancialOverviewChartViewRecord<
    ToutstandingBalance,
    TpaymentRatePercentage,
    TtotalBilled,
    TtotalPaid
  >
> &
  BaseSystemFields<Texpand>;
export type TenantsResponse<Texpand = unknown> = Required<TenantsRecord> &
  BaseSystemFields<Texpand>;
export type TenantsPerPropertyChartViewResponse<
  ToccupancyPercentage = unknown,
  Texpand = unknown,
> = Required<TenantsPerPropertyChartViewRecord<ToccupancyPercentage>> &
  BaseSystemFields<Texpand>;
export type UnitInventoryChartViewResponse<
  Tstatus = unknown,
  Texpand = unknown,
> = Required<UnitInventoryChartViewRecord<Tstatus>> & BaseSystemFields<Texpand>;
export type UnitPriceChartViewResponse<
  TavgPrice = unknown,
  TmaxPrice = unknown,
  TminPrice = unknown,
  TtotalMonthlyPotential = unknown,
...
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>;
export type WorkerPerformanceChartViewResponse<
  TavgResolutionDays = unknown,
  TcompletionRate = unknown,
  Texpand = unknown,
> = Required<
  WorkerPerformanceChartViewRecord<TavgResolutionDays, TcompletionRate>
> &
  BaseSystemFields<Texpand>;
